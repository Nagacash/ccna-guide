...
export default function HomePage() {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 min-h-screen">
      {/* Hero Section */}
      <motion.section 
        className="relative bg-gray text-white py-20 overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-yellow-500">CCNA</span> <span className="text-black">Interactive Course</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Link href="/modules" className="block w-full sm:w-auto px-8 py-4 bg-yellow-500 hover:bg-cyan-400 text-white font-bold rounded-lg shadow-lg transition-colors">
                  Start Learning
                </Link>
              </motion.div>
              <motion.div
                ...
                whileTap={{ scale: 0.95 }}
              >
                <Link href="/labs" className="block w-full sm:w-auto px-8 py-4 bg-yellow-500 hover:bg-blue-600 text-white font-bold rounded-lg shadow-lg transition-colors">
                  Explore Labs
                </Link>
              </motion.div>
            </div>

        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="https://skillcertpro.com/wp-content/uploads/2021/01/CCNA-Master-Cheat-Sheet.pdf" className="text-gray-400 hover:text-cyan-300 transition-colors">
